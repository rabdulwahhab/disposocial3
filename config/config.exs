...
config :disposocial3, :scopes,
  user: [
    default: true,
    module: Disposocial3.Accounts.Scope,
    assign_key: :current_scope,
    access_path: [:user, :id],
    schema_key: :user_id,
    schema_type: :id,
    schema_table: :users,
    test_data_fixture: Disposocial3.AccountsFixtures,
...
config :disposocial3, Disposocial3Web.Endpoint,
  ...
  live_view: [signing_salt: "9z/RPCb+"]
...
config :disposocial3, Disposocial3.Mailer, adapter: Swoosh.Adapters.Local
