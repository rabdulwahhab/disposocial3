defmodule Disposocial3Web.UserAuthTest do
  use Disposocial3Web.ConnCase

  alias Phoenix.LiveView
  alias Disposocial3.Accounts
  alias Disposocial3.Accounts.Scope
  alias Disposocial3Web.UserAuth

  import Disposocial3.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, Disposocial3Web.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      Disposocial3Web.Endpoint.subscribe(live_socket_id)
  ...
  describe "disconnect_sessions/1" do
    test "broadcasts disconnect messages for each token" do
      ...
      for %{token: token} <- tokens do
        Disposocial3Web.Endpoint.subscribe("users_sessions:#{Base.url_encode64(token)}")
      end
